			...
			*/
			...
			if(isset($account))
			{
				...
				if($Email==$admin)
				{
					...
					// 信件標題
					$mail->Body = "Hi ".$account.", please click this web to change your new password :http://steven558877.ddns.net/GraduateAdmissionApplicationSystem/AccountManager-Sub-system/newpassword.html ";
